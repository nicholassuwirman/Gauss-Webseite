...
const Department = () => {
  ...
  const links = {
    media: 'https://erleben.h-da.de/fachbereich-media',
    elektrotechnik: 'https://erleben.h-da.de/fachbereich-media',
    kunststofftechnik: 'https://erleben.h-da.de/fachbereich-media',
    informatik: 'https://erleben.h-da.de/fachbereich-media',
  };

  // Function to reset positions to original state
  ...
  const handleDepartmentsClick = (title, department, description, buttonNumber) => {
    ...
    // If the same button is clicked again, toggle the text container visibility and reset positions
    if (activeButton === buttonNumber) {
      setShowTextContainer(false);
      setActiveButton(null);
      resetPositions(); // Reset positions to original state
    } else {
